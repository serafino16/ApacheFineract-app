...
resource "kubernetes_service_account" "fineract_product_config" {
...
resource "kubernetes_deployment" "fineract_product_config" {
  metadata {
    name      = "fineract-product"
    namespace = "apache-fineract"
    labels = {
      app = "fineract-product"
    }
  }
...
resource "kubernetes_service" "fineract_product_config" {
  metadata {
    name      = "fineract-product"
    namespace = "apache-fineract"
    annotations = {
